  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={inter.className} suppressHydrationWarning>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-100 focus:rounded-lg focus:bg-slate-900 focus:px-6 focus:py-3 focus:text-white focus:font-medium focus:shadow-lg focus:outline-none focus:ring-4 focus:ring-orange-500"
        >
